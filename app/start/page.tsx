...
export default function StartPage() {
  return (
    <div className="min-h-[calc(100vh-64px)] bg-[radial-gradient(circle_at_20%_15%,rgba(104,203,255,0.13),transparent_38%),radial-gradient(circle_at_82%_18%,rgba(255,195,107,0.15),transparent_42%),#070d14] px-6 py-10">
